...
HepSeq <- Biostrings::readDNAStringSet("data/ena.fasta")
...
if(!exists("badTaxa")){
  source("R/1_Metadata_sequences.R") ##   
}
...
writeXStringSet(HepSeqFinal, "output/database/Hepatozoon_canis_final_Seq.fasta")
...
write.csv(HepDBFinal, "output/database/Metadata_H_canis_seq.csv")
